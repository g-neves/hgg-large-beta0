*
* ../../../../startform3 comhgagalargeb0.frm
*
...
load results/hgagalargeb02l1to12.res;

l res2llargebeta0 = hgagalargeb02l1to12;
.sort
...
id nc^-1 = nc - 2*Cf;
id nc = Ca;
multiply ( -i/(16*pi^2)^2 )*(4*pi)^2*M1/vev;
*id ep=0;
.sort
...
b eM1,M1 i, pi, [A], [B], as, vev, Cf, Ca, mH, Gamma, iGam, A;
